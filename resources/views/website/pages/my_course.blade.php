...
{{--                    </span>--}}
                    ...
                    <a href="{{ route('add_to_cart', $course->id) }}"
                       class="btn-filled w-100" style="height: 55px; margin-top: 27px; " role="button">
                        {{ __('cp.Add to cart') }}</a>

                    <a href="{{ route('course_checkout', $course->id) }}" class="btn-filled btn-outlined w-100 " style="height: 55px; margin-top: 13px;">Buy Now
                    </a>
                    <span class="gurantee">
            ...
            <div class="fixed-course-card col-xl-5">
            <div class="tabs-warper w-100 zoom-block">
                <div>
                    <h3>Meeting</h3>
                    <img src="{{ url(assets('website')) }}/images/zoom.png" alt="">
                </div>
                <div>
                    <h3>The duration of the meeting</h3>
                    <p>2 hours</p>
                </div>
                <div>
                    <h3>Meeting Time</h3>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h5 class="card-title">{{ $one_course->title }}</h5>
