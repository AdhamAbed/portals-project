                                ...
                                <div id="collapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="card-body">
                                        <form
                                            ...
                                            <input type="number" name="course[{{ $key }}]" value="{{  $key }}" hidden>
                                            <input type="number" name="course_price[{{ $key }}]" value="{{ $course_id['price'] }}" hidden>
                                            @endforeach
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    @else
                                                        <a href="" class="btn-filled w-100 py-4 mt-3 hh" data-bs-toggle="modal" data-bs-target="#SignIn" style="text-decoration: none;">
                                                            Complete Checkout
                                                        </a>
                                                    @endif
                                                </div>
