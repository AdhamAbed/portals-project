        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    @if(has_permission('admin.courses_categories.create') == true)
                        <a href="{{ route('admin.courses_categories.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.courses_categories.edit') == true)
                    ...
                    @if(has_permission('admin.courses_categories.destroy') == true)
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @foreach($items as $one)
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        @if(has_permission('admin.courses_categories.edit') == true)
                        <a href="{{ route('admin.courses_categories.edit', $one->id) }}" class="btn btn-xs tooltips"
