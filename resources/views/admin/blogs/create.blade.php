        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form method="post" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" class="form-horizontal" role="form" id="form">
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="6" class="form-control" name="description_{{$locale->lang}}" id="kt_docs_ckeditor_classic_{{$locale->lang}}" required aria-required="true"></textarea>
{{--                                    <textarea rows="6" class="form-control" name="description_{{$locale->lang}}" required aria-required="true"></textarea>--}}
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="6" class="form-control" name="subdescription_{{$locale->lang}}" required aria-required="true"></textarea>

{{--                                    <textarea rows="6" class="form-control" name="subdescription_{{$locale->lang}}" id="kt_docs_ckeditor_classic_{{$locale->lang}}" required aria-required="true"></textarea>--}}
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="author_{{$locale->lang}}" id="author_{{$locale->lang}}"value="{{ old('author_'.$locale->lang) }}" required>
                                </div>
                            </div>
                            @endforeach
...
{{--                                <div class="col-md-6">--}}
{{--                                    <textarea rows="6" class="form-control" name="keywords_{{$locale->lang}}" required aria-required="true"></textarea>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            @endforeach--}}
