        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.subdescription')}} </b> </label>
                            <div class="col-md-9 bold"> {!! @$item->subdescription !!} </div>
                        </div>
                    </fieldset>

                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.description') }} </b> </label>
                            <div class="col-md-9 bold"> {!! @$item->description !!} </div>
                        </div>
                    </fieldset>

                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.author') }} </b> </label>
                            <div class="col-md-9 bold"> {{ $item->author }} </div>
                            {{--                            <div class="col-md-9 bold"> <a href="{{ $item->reference_link }}" target="_blank"> {{ $item->author }} </a> </div>--}}
                        </div>
                    </fieldset>
...
{{--                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">--}}
{{--                        <div class="form-group">--}}
{{--                            <label class="col-sm-3 control-label"> <b> {{ __('cp.keywords')}} </b> </label>--}}
{{--                            <div class="col-md-9 bold"> {{ $item->keywords }} </div>--}}
{{--                        </div>--}}
{{--                    </fieldset>--}}
...
{{--                    </fieldset>--}}
                    ...
                    @if(count($item->photos) > 0)
                        ...
                        @foreach($item->photos as $one)
                            <fieldset style="padding: 10px;">
                                <div class="form-group">
                                    <div class="col-md-12 bold"><img src="{{ $one->image }}" style="max-width:600px;">
                                    </div>
                                </div>
                            </fieldset>
                        @endforeach
