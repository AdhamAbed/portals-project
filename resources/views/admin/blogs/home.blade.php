        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    @if(has_permission('admin.blogs.create') == true)
                        <a href="{{ route('admin.blogs.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.blogs.edit') == true)
                    ...
                    @if(has_permission('admin.blogs.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                             ...
                             @if(has_permission('admin.blogs.show') == true)
                        <a href="{{ route('admin.blogs.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.blogs.edit') == true)
                        <a href="{{ route('admin.blogs.edit', $one->id) }}" class="btn btn-xs tooltips"
