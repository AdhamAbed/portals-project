...
@if(has_permission('admin.ambassadors.create') == true)
                        <a href="{{ route('admin.ambassadors.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.ambassadors.edit') == true)
                    ...
                    @if(has_permission('admin.ambassadors.destroy') == true)
      ...
      @if(has_permission('admin.ambassadors.show') == true)
                        <a href="{{ route('admin.ambassadors.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.ambassadors.edit') == true)
                        <a href="{{ route('admin.ambassadors.edit', $one->id) }}" class="btn btn-xs tooltips"
