                ...
                <div class="portlet-body form">
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 bold"> {{ @$item->association->name }} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.facebook') }} </b> </label>
                            <div class="col-md-9 bold"> <a href="{{ $item->facebook }}" target="_blank"> {{ $item->facebook }} </a> </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.instagram') }} </b> </label>
                            <div class="col-md-9 bold"> <a href="{{ $item->instagram }}" target="_blank"> {{ $item->instagram }} </a> </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.twitter') }} </b> </label>
                            <div class="col-md-9 bold"> <a href="{{ $item->twitter }}" target="_blank"> {{ $item->twitter }} </a> </div>
                        </div>
                    </fieldset>
