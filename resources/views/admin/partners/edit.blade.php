...
@section('content')
    ...
    <form method="post" action="{{ route('admin.partners.update',$item->id) }}" enctype="multipart/form-data"
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <a href="{{ route('admin.partners.index') }}" class="btn btn-warning">{{__('cp.cancel')}}</a>
                    </div>
                </div>
            </div>
        </div>
