        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    @if(has_permission('admin.consultations_categories.edit') == true)
                    ...
                    @if(has_permission('admin.consultations_categories.destroy') == true)
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @foreach($items as $one)
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        @if(has_permission('admin.consultations_categories.edit') == true)
                        <a href="{{ route('admin.consultations_categories.edit', $one->id) }}" class="btn btn-xs tooltips"
