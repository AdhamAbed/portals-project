        ...
        <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea rows="5" class="form-control" name="sub_description_{{$locale->lang}}"
                                  ...
                                  placeholder=" {{__('cp.sub_description_'.$locale->lang)}}" {{ old('sub_description_'.$locale->lang) }}></textarea>
                    </div>
                </div>
            @endforeach  @foreach($locales as $locale)
                <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <input type="file" class="form-control" name="image" accept="image/*" value="{{old('image')}}"
                           id="edit_image" required style="display:none">
                </div>
            </div>
            <br>
