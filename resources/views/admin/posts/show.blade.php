        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.publication_time') }} </b> </label>
                            <div class="col-md-9 bold"> {{ @$item->publication_time }} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.reference_link') }} </b> </label>
                            <div class="col-md-9 bold"> <a href="{{ $item->reference_link }}" target="_blank"> {{ $item->reference_link }} </a> </div>
                        </div>
                    </fieldset>
