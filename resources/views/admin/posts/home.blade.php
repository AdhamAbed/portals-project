                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                                 ...
                                 @if(has_permission('admin.posts.create') == true)
                        <a href="{{ route('admin.posts.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.posts.edit') == true)
                    ...
                    @if(has_permission('admin.posts.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                  ...
                                  @if(has_permission('admin.posts.show') == true)
                        <a href="{{ route('admin.posts.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.posts.edit') == true)
                        <a href="{{ route('admin.posts.edit', $one->id) }}" class="btn btn-xs tooltips"
