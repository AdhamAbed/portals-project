                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            @if(has_permission('admin.features.create') == true)
                                <a href="{{ route('admin.features.create') }}" style="margin-right: 5px"
                            ...
                            @if(has_permission('admin.features.edit') == true)
                            ...
                            @endif
                            @if(has_permission('admin.features.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                ...
                                @if(has_permission('admin.features.edit') == true)
                                    <a href="{{ route('admin.features.edit', $one->id) }}" class="btn btn-xs tooltips"
