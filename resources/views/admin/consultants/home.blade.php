                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            @if(has_permission('admin.consultants.create') == true)
                                <a href="{{ route('admin.consultants.create') }}" style="margin-right: 5px"
                            ...
                            @if(has_permission('admin.consultants.edit') == true)
                            ...
                            @endif
                            @if(has_permission('admin.consultants.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                ...
                                @if(has_permission('admin.consultants.edit') == true)
                                    <a href="{{ route('admin.consultants.edit', $one->id) }}" class="btn btn-xs tooltips"
