...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        @if(has_permission('admin.courses.create') == true)
                        <a href="{{ route('admin.lessons.create', ['id' => $unit->id]) }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
...
{{--                        <a href="{{ route('admin.lessons_links.index', ['id' => $one->id]) }}" class="btn btn-xs tooltips" title="{{ __('cp.lesson_links') }}"--}}
{{--                           data-container="body" data-placement="top" data-original-title="{{ __('cp.lesson_links') }}">--}}
{{--                            <i class="fas fa-link"></i>--}}
{{--                        </a>--}}

                        
{{--                        <a href="{{ route('admin.lessons_files.index', ['id' => $one->id]) }}" class="btn btn-xs tooltips" title="{{ __('cp.files') }}"--}}
{{--                           data-container="body" data-placement="top" data-original-title="{{ __('cp.files') }}">--}}
{{--                            <i class="fas fa-file"></i>--}}
{{--                        </a>--}}

            
                        <a href="{{ route('admin.lessons.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.courses.edit') == true)
                        <a href="{{ route('admin.lessons.edit', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.courses.destory') == true)
