        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.writer')}} </b> </label>
                            <div class="col-md-9 bold"> {!! @$item->writer !!} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.study_sample')}} </b> </label>
                            <div class="col-md-9 bold"> {!! @$item->study_sample !!} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.file') }} </b> </label>
                            <div class="col-md-9 bold"> <a href="{{ $item->file }}" target="_blank"> {{ $item->file }} </a> </div>
                        </div>
                    </fieldset>
