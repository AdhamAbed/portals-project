...
@section('content')
 ...
 @if(has_permission('admin.research_studies.create') == true)
                        <a href="{{ route('admin.research_studies.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.research_studies.edit') == true)
                    ...
                    @if(has_permission('admin.research_studies.destroy') == true)
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @if(has_permission('admin.research_studies.show') == true)
                        <a href="{{ route('admin.research_studies.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.research_studies.edit') == true)
                        <a href="{{ route('admin.research_studies.edit', $one->id) }}" class="btn btn-xs tooltips"
