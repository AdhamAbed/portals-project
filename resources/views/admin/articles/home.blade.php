        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    @if(has_permission('admin.articles.create') == true)
                        <a href="{{ route('admin.articles.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.articles.edit') == true)
                    ...
                    @if(has_permission('admin.articles.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                             ...
                             @if(has_permission('admin.articles.show') == true)
                        <a href="{{ route('admin.articles.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.articles.edit') == true)
                        <a href="{{ route('admin.articles.edit', $one->id) }}" class="btn btn-xs tooltips"
