        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                 ...
                 @if(has_permission('admin.roles.create') == true)
                        <a href="{{ route('admin.roles.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.roles.edit') == true)
                    ...
                    @if(has_permission('admin.roles.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                            ...
                                            @if(has_permission('admin.roles.edit') == true)
                        <a href="{{ route('admin.roles.edit', $one->id) }}" class="btn btn-xs tooltips"
