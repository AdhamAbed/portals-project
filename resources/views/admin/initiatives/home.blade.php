        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    <!--@if(has_permission('admin.initiatives.create') == true)-->
                    <!--    <a href="{{ route('admin.initiatives.create') }}" style="margin-right: 5px" class="btn btn-primary">-->
                    <!--        {{ __('cp.add') }}-->
                    ...
                    @if(has_permission('admin.initiatives.edit') == true)
                    ...
                    @if(has_permission('admin.events.destroy') == true)
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @foreach($items as $one)
                  ...
                  @if(has_permission('admin.initiatives.show') == true)
                        <a href="{{ route('admin.initiatives.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.initiatives.edit') == true)
                        <a href="{{ route('admin.initiatives.edit', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.initiatives.destroy') == true)
