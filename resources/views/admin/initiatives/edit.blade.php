        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <form method="post" action="{{ route('admin.initiatives.update',$item->id) }}" enctype="multipart/form-data" class="form-horizontal" role="form" id="form">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                            ...
                            <div class="form-group" id="type">
                                ...
                                <div class="col-md-6 input-field">
                                    <select class="form-control select02" name="type">
                                        <option value="general" {{ $item->type == 'general' ? 'selected' : '' }}> {{ __('cp.general') }} </option>
                                        <option value="private" {{ $item->type == 'private' ? 'selected' : '' }}> {{ __('cp.private') }} </option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">  
                                        <select name="association_id" id="association_id" class="form-control">
                                            @foreach($associations as $one)
                                                <option {{ $item->association_id == $one->id? "selected" : "" }} value="{{ $one->id}}">{{$one->title }}</option>
                                            @endforeach   
                                        </select>           
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="url" class="form-control" name="join_link" value="{{old('reference_link', $item->join_link)}}">
                                </div>
                            </div>     
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{ route('admin.initiatives.index') }}" class="btn btn-warning"> {{ __('cp.cancel') }} </a>
                                    </div>
                                </div>
                            </div>
