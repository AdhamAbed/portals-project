        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    @if(has_permission('admin.events.create') == true)
                        <a href="{{ route('admin.events.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.events.edit') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                          ...
                                          @if(has_permission('admin.events.show') == true)
                        <a href="{{ route('admin.events.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.events.edit') == true)
                        <a href="{{ route('admin.events.edit', $one->id) }}" class="btn btn-xs tooltips"
