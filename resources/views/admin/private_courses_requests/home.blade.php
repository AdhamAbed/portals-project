...
{{--                    @if(has_permission('admin.private_courses_requests.edit') == true)--}}
...
{{--                    @endif--}}
                    ...
                    @if(has_permission('admin.private_courses_requests.destroy') == true)
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('cp.company'))}} </th>
                    <th> {{ucwords(__('cp.email'))}} </th>
                    <th> {{ucwords(__('cp.reading'))}} </th>
...
{{--                        </td>--}}
                        ...
                        @if(has_permission('admin.private_courses_requests.edit') == true)
                        <a href="{{ route('admin.private_courses_requests.edit', $one->id) }}" class="btn btn-xs tooltips"
