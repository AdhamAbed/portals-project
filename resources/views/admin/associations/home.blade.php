...
@if(has_permission('admin.associations.create') == true)
                        <a href="{{ route('admin.associations.create') }}" style="margin-right: 5px" class="btn btn-primary">
                            {{ __('cp.add') }}
                    ...
                    @if(has_permission('admin.associations.edit') == true)
                    ...
                    @if(has_permission('admin.associations.destroy') == true)
         ...
         @if(has_permission('admin.associations.show') == true)
                        <a href="{{ route('admin.associations.show', $one->id) }}" class="btn btn-xs tooltips"
                        ...
                        @if(has_permission('admin.associations.edit') == true)
                        <a href="{{ route('admin.associations.edit', $one->id) }}" class="btn btn-xs tooltips"
