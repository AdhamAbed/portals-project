        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <div class="fileinput-new thumbnail">
                                    <img src="{{ $item->image }}" style="max-width:600px;">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.country') }} </b> </label>
                            <div class="col-md-9 bold"> {{ @$item->country->name }} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.city') }} </b> </label>
                            <div class="col-md-9 bold"> {{ @$item->city->name }} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.mobile') }} </b> </label>
                          ...
                          <fieldset style="padding: 10px; border-bottom:1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> <b> {{ __('cp.email') }} </b> </label>
                            <div class="col-md-9 bold"> {{ @$item->email }} </div>
                        </div>
                    </fieldset>
