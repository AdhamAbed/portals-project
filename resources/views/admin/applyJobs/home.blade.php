        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    ...
                    @if(has_permission('admin.apply_jobs.edit') == true)
                    ...
                    @if(has_permission('admin.apply_jobs.destroy') == true)
...
{{--                        </td>--}}
                        ...
                        @if(has_permission('admin.apply_jobs.edit') == true)
                        <a href="{{ route('admin.apply_jobs.edit', $one->id) }}" class="btn btn-xs tooltips"
