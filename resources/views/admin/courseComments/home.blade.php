                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.courseComments.create') }}" style="margin-right: 5px"
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{ route('admin.courseComments.edit', $one->id) }}" class="btn btn-xs tooltips"
