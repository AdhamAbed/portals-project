<nav class="navbar  navbar-expand-xl navbar-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse menues" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " aria-current="page" data-scroll="training-section" href="https://training.smeportals.com/#training-section">Training Features</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" aria-current="page" data-scroll="course-cont" href="https://training.smeportals.com/#course-cont">Training Courses</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link  " aria-current="page" data-scroll="opinions-section" href="https://training.smeportals.com/#opinions-section">Testimonials</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link " aria-current="page" data-scroll="happy-clients" href="https://training.smeportals.com/#happy-clients">Happy Clients</a>
                </li>
            </ul>
            <di>
             <!-- {{--  @if(Auth::check())--}}-->
