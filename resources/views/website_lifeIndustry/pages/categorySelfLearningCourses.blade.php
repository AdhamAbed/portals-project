        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 text-{{ $float }}">
                    ...
                    /
                    <a href="{{ route('selfLearningCourses') }}" class="link-page"> {{ __('cp.Professional education courses') }}</a>
                 /
                    <a href="{{ route('categorySelfLearningCourses' , ['id' => $course_category->id]) }}" class="link-page active"> {{ @$course_category->name }} </a>
                </div>
            </div>
            <div class="row">
