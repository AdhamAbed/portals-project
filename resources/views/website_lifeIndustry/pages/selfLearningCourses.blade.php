        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 text-{{ $float }}">
                    ...
                    /
                    <a href="{{ route('selfLearningCourses') }}" class="link-page active"> {{ __('cp.Professional education courses') }}</a>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="course-categories-item">
                            <div class="course-categories-info">
                                ...
                                <div class="course-category-info">
                                    <a href="{{ route('categorySelfLearningCourses' , ['id' => $courses_category->id]) }}">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-{{ $float_op }} course-category-name">
                    <ul class="nav">
                        ...
                        <h3> | </h3>
                        <li class="nav-item">
                            <a href="{{ route('selfLearningCourses') }}" class="tap-active">
                        ...
                        <div class="card">
                            ...
                            @else
                                <div class="course-type">
                                    <a class="tap-active">
                                        <input type="radio" id="course_type" checked>
                                        <span>{{ __('cp.live') }}</span>
                                    </a>
                                </div>
                            @endif
